...
(function (au, k) {
    ...
    var T = {};
    T.markup = '<div id="sb-container"><div id="sb-overlay"><a id="sb-nav-close" title="" onclick="Shadowbox.close()"><i class="icon-close"></i></a></div><div id="sb-wrapper"><div id="sb-title"><div id="sb-title-inner" class="text-center"></div></div><div id="sb-wrapper-inner"><div id="sb-body"><div id="sb-body-inner"></div><div id="sb-loading"><div id="sb-loading-inner"><img src="/static/main/img/loader.gif" alt=""/></div></div></div></div><div id="sb-info"><div id="sb-info-inner"><div id="sb-nav"><div id="sb-counter"></div><a id="sb-nav-previous" title="" onclick="Shadowbox.previous()"><i class="icon-arrow-left-2"></i></a><a id="sb-nav-next" title="" onclick="Shadowbox.next()"><i class="icon-arrow-right-2"></i></a><a id="sb-nav-play" title="" onclick="Shadowbox.play()"><i class="icon-play-3"></i></a><a id="sb-nav-pause" title="" onclick="Shadowbox.pause()"><i class="icon-pause-2"></i></a></div></div></div></div></div>';
    T.options = {
        animSequence: "sync",
        counterLimit: 10,
        counterType: "default",
